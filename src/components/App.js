  ...
  useEffect(() => {
    ...
    return (
      <div  class="bg-green-50 flex flex-col justify-center max-w-full max-h-screen" >          
          <div>
            <h2 class="text-gray-800 text-4xl font-semibold text-center my-5">Pet Helper Dapp</h2>
          </div>
                      ...
                      <table class="min-w-max w-full table-auto">
                          <thead>
                              <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                                  ...
                                  <th class="py-3 px-6 text-left">Pet's Name</th>
                                  <th class="py-3 px-6 text-center">Person In Charge</th>
                                  <th class="py-3 px-6 text-center">Info</th>
                                  <th class="py-3 px-6 text-center">Help ❤️</th>
                              </tr>
                          </thead>
